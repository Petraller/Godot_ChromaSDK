...
namespace godot
{
	class NodeChromaSDK : public Node {
		GDCLASS(NodeChromaSDK, Node)
...
#pragma region autogenerated
		...
		*/
		int CoreStreamGetStatus();
		/*
			Convert StreamStatusType to a printable string
		*/
		String CoreStreamGetStatusString(
			int status);
		/*
		...
		*/
		String GetAnimationName(int animationId);
		/*
